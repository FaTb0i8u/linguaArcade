 ...
 * Covers B2 grammar points: 不僅...而且, 無論...都, 即使...也,
 * 吧 advanced uses, topic-comment, 連...都/也, formal connectors.
 */
...
export const CHINESE_B2_SENTENCES: SentencePattern[] = [
  ...
  },
  {
    ...
    words: ['關于', '這個', '问题', '我', '有', '一些', '看法'],
    translation: 'Regarding this issue, I have some opinions.',
    hint: '關于 + Topic，Subject + Comment — formal topic marker',
    distractors: ['對于', '因為'],
  },
