 ...
 * Covers A2 grammar points: completed actions (了), experience (過),
...
export const CHINESE_A2_SENTENCES: SentencePattern[] = [
  ...
  },
  {
    ...
    hint: 'Verb + 過 + 嗎 = asking about experience',
    distractors: ['了', '沒'],
  },
  ...
  },
  {
    ...
    hint: 'A + 沒有 + B + adjective = negative comparison',
    distractors: ['比', '不'],
  },
